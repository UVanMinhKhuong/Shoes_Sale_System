...
public class DatabaseContext extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS USER (ID INTEGER PRIMARY KEY AUTOINCREMENT, USERNAME TEXT NOT NULL, PASSWORD TEXT NOT NULL, FIRST_NAME TEXT, LAST_NAME TEXT, EMAIL TEXT, JOINED_DATE DATE)");
